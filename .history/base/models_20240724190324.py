...
class Inventory(models.Model):
    ...
    sku = models.CharField(default= "N/A", max_length=255, unique=True)
    ...
    category = models.CharField(default= "Sneaker", max_length=50, choices=[('Sneakers', 'Sneakers'), ('Streetwear', 'Streetwear')])
