...
class Profile(models.Model):
    ...
    profit_goal = models.DecimalField(max_digits=10, decimal_places=2, default=1000)
    sales_goal = models.PositiveIntegerField(default=100, decimal_places = 2)
    inventory_goal = models.PositiveIntegerField(default=100, decimal_places = 2)
    def __str__(self):
