...
class Profile(models.Model):
    ...
    profile_pic = models.ImageField(default='images/default_image.jpg', upload_to='images/', null=True, blank=True)
    instagram = models.URLField(max_length=200, blank=True)
    inventory_link = models.URLField(max_length=200, blank = True)
    profit_goal = models.DecimalField(max_digits=10, decimal_places=2, default=1000.00)
    sales_goal = models.DecimalField(max_digits=10, decimal_places=2, default=100.00)
    inventory_goal = models.DecimalField(max_digits=10, decimal_places=2, default=100.00)
