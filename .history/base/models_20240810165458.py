...
class Inventory(models.Model):
    ...
    price_paid = models.DecimalField(default=0, max_digits=10, decimal_places=4)
    price_sold = models.DecimalField(default=0, max_digits=10, decimal_places=2, null=True, blank=True)
    profit = models.DecimalField(default=0, max_digits=10, decimal_places=2, blank=True, null=True)
    ...
    def save(self, *args, **kwargs):
            # Check if the instance is being updated and track the original status
            if self.pk:
            ...
            # Update inventory count based on quantity
            self.inventory_count = self.quantity
