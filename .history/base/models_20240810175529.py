...
class Inventory(models.Model):
    ...
    def get_profile(self):
        # Assuming each Inventory item is linked to a Profile via the user who created it
        # You would need to have a ForeignKey to User in Inventory or some other link to Profile
        return Profile.objects.get(user=self.user)  # This is an assumption, adjust as needed
