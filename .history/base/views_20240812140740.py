...
def dashboard(request):
    ...
    # Define total_sales, total_inventory, and total_profit
    ...
    context = {
        ...
        'sales_percentage': calculate_sales_percentage(daily_metrics, total_sales),
        'inventory_percentage': calculate_inventory_percentage(daily_metrics, total_inventory),
        'profit_percentage': calculate_profit_percentage(daily_metrics, total_profit),
    }
