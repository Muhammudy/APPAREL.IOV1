...
def dashboard(request):
    ...
    # Debugging: Log the daily totals
    logger.debug(f"Daily Totals: Sales={daily_total_sales}, Inventory={daily_total_inventory}, Profit={daily_total_profit}")
    ...
    logger.debug(f"Monthly Totals: Sales={monthly_total_sales}, Inventory={monthly_total_inventory}, Profit={monthly_total_profit}")
    ...
    # Debugging: Log the yearly totals
    logger.debug(f"Yearly Totals: Sales={yearly_total_sales}, Inventory={yearly_total_inventory}, Profit={yearly_total_profit}")
    ...
    # Debugging: Log the daily percentages
    logger.debug(f"Daily Percentages: Sales={daily_sales_percentage}%, Inventory={daily_inventory_percentage}%, Profit={daily_profit_percentage}%")
    ...
    # Debugging: Log the monthly percentages
    logger.debug(f"Monthly Percentages: Sales={monthly_sales_percentage}%, Inventory={monthly_inventory_percentage}%, Profit={monthly_profit_percentage}%")
    ...
    # Debugging: Log the yearly percentages
    logger.debug(f"Yearly Percentages: Sales={yearly_sales_percentage}%, Inventory={yearly_inventory_percentage}%, Profit={yearly_profit_percentage}%")
