...
def dashboard(request):
    ...
    # Debugging: Print the fetched metrics to the console
    print(f"Daily Metrics: {daily_metrics}")
    print(f"Monthly Metrics: {monthly_metrics}")
    print(f"Yearly Metrics: {yearly_metrics}")
    ...
    # Debugging: Print the calculated totals to the console
    ...
    # Debugging: Print the calculated percentages to the console
