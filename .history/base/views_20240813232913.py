...
def settings(request):
    ...
    if request.method == 'POST':
        ...
        daily_form = DailyMetricsForm(request.POST, instance=profile)
        monthly_form = MonthlyMetricsForm(request.POST, instance=profile)
        yearly_form = YearlyMetricsForm(request.POST, instance=profile)
        ...
        # Get or create instances of DailyMetrics, MonthlyMetrics, and YearlyMetrics for the current user
        daily_metrics, created = DailyMetrics.objects.get_or_create(user=request.user, date=timezone.now().date())
        monthly_metrics, created = MonthlyMetrics.objects.get_or_create(user=request.user, year=timezone.now().year, month=timezone.now().month)
        yearly_metrics, created = YearlyMetrics.objects.get_or_create(user=request.user, year=timezone.now().year)

        # Pass these instances to the forms
...
def dashboard(request):
    ...
    # Debugging: Print the daily totals
    print(f"Daily Totals: Sales={daily_total_sales}, Inventory={daily_total_inventory}, Profit={daily_total_profit}")
    ...
    # Debugging: Print the monthly totals
    print(f"Monthly Totals: Sales={monthly_total_sales}, Inventory={monthly_total_inventory}, Profit={monthly_total_profit}")
    ...
    # Debugging: Print the yearly totals
    print(f"Yearly Totals: Sales={yearly_total_sales}, Inventory={yearly_total_inventory}, Profit={yearly_total_profit}")
    ...
    # Debugging: Print the daily percentages
    print(f"Daily Percentages: Sales={daily_sales_percentage}%, Inventory={daily_inventory_percentage}%, Profit={daily_profit_percentage}%")
    ...
    # Debugging: Print the monthly percentages
    print(f"Monthly Percentages: Sales={monthly_sales_percentage}%, Inventory={monthly_inventory_percentage}%, Profit={monthly_profit_percentage}%")
    ...
    # Debugging: Print the yearly percentages
    print(f"Yearly Percentages: Sales={yearly_sales_percentage}%, Inventory={yearly_inventory_percentage}%, Profit={yearly_profit_percentage}%")
