...
def dashboard(request):
    ...
    if daily_metrics is None:
        # Handle the case where daily_metrics is None
        daily_metrics.daily_sales_goal = 0
        daily_metrics.daily_inventory_goal = 0
        daily_metrics.daily_profit_goal = 0
    else:
        # If daily_metrics is not None, access its attributes
    ...
    daily_sales_percentage = calculate_sales_percentage(daily_metrics, daily_metrics.daily_sales_goal)
    daily_inventory_percentage = calculate_inventory_percentage(daily_metrics, daily_metrics.daily_inventory_goal)
    daily_profit_percentage = calculate_profit_percentage(daily_metrics, daily_metrics.daily_profit_goal)
